...
class BalancedBinningReference(FeatureVisualizer):
    ...
    def draw(self, X, **kwargs):
        ...
        self.ax.vlines(get_vline_value(X), 0, 1, transform=self.ax.get_xaxis_transform(), colors='r')
        print("The binning reference values are:", get_vline_value(X))
